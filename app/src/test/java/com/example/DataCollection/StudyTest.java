...
public class StudyTest extends TestCase{
    ...
    public void testAddSite() {
        ...
        assertEquals("The site isn't in the study", true, myStudy.getAllSites().contains(mySite1));
    }
    ...
    public void testSetAllToCollect() {
        ...
        for(Site s : myStudy.getAllSites()) {
    ...
    public void testSetSiteForReading() {
        ...
        myStudy.setSitesForReading(read);
    ...
    public void testGetAllSite() {
        ...
        assertTrue("Sites not included", myStudy.getAllSites().contains(mySite1) && myStudy.getAllSites().contains(mySite2));
    }
